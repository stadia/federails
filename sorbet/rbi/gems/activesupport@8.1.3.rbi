...
# pkg:gem/activesupport#lib/active_support/testing/stream.rb:4
...
# pkg:gem/activesupport#lib/active_support/testing/stream.rb:5
module ActiveSupport::Testing::Stream
  private

  # pkg:gem/activesupport#lib/active_support/testing/stream.rb:23
  def capture(stream); end

  # pkg:gem/activesupport#lib/active_support/testing/stream.rb:17
  def quietly(&block); end

  # pkg:gem/activesupport#lib/active_support/testing/stream.rb:7
