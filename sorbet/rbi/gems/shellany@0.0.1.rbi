...
# pkg:gem/shellany#lib/shellany/sheller.rb:3
module Shellany; end

# The Guard sheller abstract the actual subshell
# calls and allow easier stubbing.
#
# pkg:gem/shellany#lib/shellany/sheller.rb:7
class Shellany::Sheller
  ...
  #
  # pkg:gem/shellany#lib/shellany/sheller.rb:16
  ...
  #
  # pkg:gem/shellany#lib/shellany/sheller.rb:68
  def ok?; end
  ...
  #
  # pkg:gem/shellany#lib/shellany/sheller.rb:60
  def ran?; end
  ...
  # @return [Boolean] whether or not the command succeeded.
  #
  # pkg:gem/shellany#lib/shellany/sheller.rb:44
  def run; end

  # pkg:gem/shellany#lib/shellany/sheller.rb:8
  def status; end
  ...
  #
  # pkg:gem/shellany#lib/shellany/sheller.rb:88
  def stderr; end
  ...
  # @return [String] the command output
  #
  # pkg:gem/shellany#lib/shellany/sheller.rb:78
  def stdout; end

  class << self
    # Only needed on JRUBY, because MRI properly detects ';' and metachars
    #
    # pkg:gem/shellany#lib/shellany/sheller.rb:128
    def _shellize_if_needed(args); end

    # pkg:gem/shellany#lib/shellany/sheller.rb:110
    def _system_with_capture(*args); end

    # pkg:gem/shellany#lib/shellany/sheller.rb:103
    def _system_with_no_capture(*args); end

    # Shortcut for new(command).run
    #
    # pkg:gem/shellany#lib/shellany/sheller.rb:24
    def run(*args); end

    # Shortcut for new(command).run.stderr
    #
    # pkg:gem/shellany#lib/shellany/sheller.rb:36
    def stderr(*args); end

    # Shortcut for new(command).run.stdout
    #
    # pkg:gem/shellany#lib/shellany/sheller.rb:30
    def stdout(*args); end
    ...
    #
    # pkg:gem/shellany#lib/shellany/sheller.rb:99
    def system(*args); end
  end
end
