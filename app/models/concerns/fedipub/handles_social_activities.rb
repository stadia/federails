...
module Fedipub
  ...
  module HandlesSocialActivities
    ...
    included do
      attr_accessor :current_fedipub_activity_actor

      define_callbacks :on_fedipub_like_received
      define_callbacks :on_fedipub_undo_like_received
      define_callbacks :on_fedipub_announce_received
      define_callbacks :on_fedipub_undo_announce_received
    end
  end
end
