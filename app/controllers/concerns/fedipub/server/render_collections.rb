  ...
  module Server
    module RenderCollections
      ...
      included do
        ...
        require_dependency 'fedipub/server/ordered_collection_resource'
      end
      ...
      def render_collection(actor:, collection:, url_helper:, &items_block)
        ...
        render_serialized(
          Fedipub::Server::OrderedCollectionResource,
          payload,
      ...
      def collection_summary_payload(actor:, pagy:, url_helper:)
        Fedipub::Server::OrderedCollectionPayload.new(
      ...
      def url_for_collection(url_helper, actor, **params)
        Fedipub::Engine.routes.url_helpers.send(url_helper, actor, **params)
      end
    end
  end
end
