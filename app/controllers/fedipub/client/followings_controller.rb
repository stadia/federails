      ...
      def accept
        respond_to do |format|
          ...
          if @following.accept!(follow_activity: @following.follow_activity)
            ...
            format.json { render_serialized(Fedipub::Client::FollowingResource, @following, status: :ok, location: @following) }
          else
      ...
      def save_and_render
        ...
        respond_to do |format|
          if @following.save
            ...
            format.json { render_serialized(Fedipub::Client::FollowingResource, @following, status: :created, location: @following) }
          else
