  ...
  module Server
    class ActorsController < Fedipub::ServerController
      ...
      def show
        ...
        resource_class = @actor.tombstoned? ? Fedipub::Server::ActorTombstoneResource : Fedipub::Server::ActorResource
      ...
      def liked
        render_collection(
          collection: Fedipub::Activity.includes(:entity).where(actor: @actor, action: 'Like').order(created_at: :desc),
          actor:      @actor,
      ...
      def featured_tags
        render_collection(
          ...
          base_url = Fedipub.configuration.site_host
