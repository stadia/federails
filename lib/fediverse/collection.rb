...
module Fediverse
  class Collection < Array
    ...
    def fetch(url, max_pages: DEFAULT_MAX_PAGES)
      ...
      raise Fedipub::Utils::JsonRequest::UnhandledResponseStatus, "Unhandled status code for GET #{url}" unless json
      ...
      while next_url_or_page && pages_fetched < max_pages
        ...
        raise Fedipub::Utils::JsonRequest::UnhandledResponseStatus, "Unhandled status code for GET #{next_url_or_page}" unless page
