...
ActiveRecord::Schema[8.1].define(version: 2026_08_28_000000) do
  ...
  create_table "fedipub_blocks", force: :cascade do |t|
    t.integer "actor_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "fedipub_featured_items", force: :cascade do |t|
    t.integer "actor_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "fedipub_featured_tags", force: :cascade do |t|
    t.integer "actor_id", null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "fedipub_blocks", "fedipub_actors", column: "actor_id"
  add_foreign_key "fedipub_blocks", "fedipub_actors", column: "target_actor_id"
  add_foreign_key "fedipub_featured_items", "fedipub_actors", column: "actor_id"
  add_foreign_key "fedipub_featured_tags", "fedipub_actors", column: "actor_id"
