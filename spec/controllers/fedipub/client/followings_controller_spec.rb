...
RSpec.describe Fedipub::Client::FollowingsController, type: :controller do
  routes { Fedipub::Engine.routes }
  render_views
  ...
  describe 'POST #create' do
    it 'creates a following and renders json' do
      ...
      aggregate_failures do
        expect(body['actor_id']).to eq(user.fedipub_actor.id)
  ...
  describe 'PUT #accept' do
    let(:incoming_following) { FactoryBot.create :following, actor: target_actor, target_actor: user.fedipub_actor }
  ...
  describe 'DELETE #destroy' do
    let!(:following) { FactoryBot.create :following, actor: user.fedipub_actor, target_actor: target_actor }
