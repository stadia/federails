  ...
  RSpec.describe DataEntity do
    ...
    describe 'social activity hooks' do
      it 'defines callback registration methods' do
        expect(Fixtures::Classes::FakeDataModel).to respond_to(:on_fedipub_like_received)
        expect(Fixtures::Classes::FakeDataModel).to respond_to(:on_fedipub_undo_like_received)
        expect(Fixtures::Classes::FakeDataModel).to respond_to(:on_fedipub_announce_received)
        expect(Fixtures::Classes::FakeDataModel).to respond_to(:on_fedipub_undo_announce_received)
      end
      ...
      it 'passes the social activity actor to registered callback methods' do
        klass = Class.new do
          ...
          on_fedipub_like_received :handle_like
        ...
        instance = klass.new
        instance.current_fedipub_activity_actor = 'https://remote.example/users/alice'

        instance.run_callbacks(:on_fedipub_like_received) { true }
