...
RSpec.describe '/followings', type: :request do
  ...
  let(:following) { FactoryBot.create :following, actor: signed_in_user.fedipub_actor, target_actor: target_actor }
  let(:incoming_following) { FactoryBot.create :following, actor: target_actor, target_actor: signed_in_user.fedipub_actor }
    ...
    context 'with authenticated user' do
      ...
      context 'with valid parameters' do
        it 'redirects to the actors profile' do
          get fedipub.new_client_following_url, params: { uri: target_actor.federated_url }
          expect(response).to redirect_to(fedipub.client_actor_url(target_actor))
        end
      end
    end
  end
  ...
  describe 'POST /create' do
    ...
    context 'with authenticated user' do
      ...
      context 'with valid parameters' do
        ...
        it 'redirects to the actors profile' do
          post fedipub.client_followings_url, params: { following: valid_attributes }
          expect(response).to redirect_to(fedipub.client_actor_url(signed_in_user.fedipub_actor))
        end
      end
    ...
    context 'with authenticated user' do
      ...
      context 'with invalid account' do
        ...
        it 'redirects to the actors list' do
          post fedipub.follow_client_followings_url(account: 'non_existing_account')
          expect(response).to redirect_to(fedipub.client_actors_url)
        end
      end
    end
  end
  ...
  describe 'PUT /id:/accept' do
    context 'with unauthenticated user' do
      it 'redirects to the login page' do
        put fedipub.accept_client_following_url(following)
        expect(response).to redirect_to(new_user_session_url)
      end
    end
    ...
    context 'with authenticated user' do
      ...
      context 'when user is the targeted user' do
        it 'changes the state of the following' do
          put fedipub.accept_client_following_url(incoming_following)
        ...
        it 'redirects to the actors profile' do
          put fedipub.accept_client_following_url(incoming_following)
          expect(response).to redirect_to(fedipub.client_actor_url(incoming_following.actor))
        end
      end
